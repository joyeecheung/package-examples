...
This is the most traditional way of creating a package in Node.js, using the CommonJS module system.
...
When users import this package, they can do so like this:
